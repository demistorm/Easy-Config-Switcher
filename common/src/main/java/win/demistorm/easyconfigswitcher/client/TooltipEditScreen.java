...
public class TooltipEditScreen extends Screen {
    ...
    public void extractRenderState(GuiGraphicsExtractor context, int mouseX, int mouseY, float delta) {
        ...
        context.centeredText(font, title, width / 2, height / 2 - EDITBOX_HEIGHT / 2 - 24, 0xFFFFFFFF);

        String tip = "This text appears when hovering the preset button on the title screen";
        context.centeredText(font, tip, width / 2, height / 2 - EDITBOX_HEIGHT / 2 - 12, 0xFFAAAAAA);
